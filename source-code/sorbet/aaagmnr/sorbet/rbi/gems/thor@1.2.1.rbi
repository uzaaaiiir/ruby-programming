...
module Thor::Actions
  ...
  # ==== Example
  #
  #   append_to_file 'config/environments/test.md', 'config.gem "rspec"'
  #
  #   append_to_file 'config/environments/test.md' do
  #     'config.gem "rspec"'
  #   end
  #
  ...
  # ==== Example
  #
  #   prepend_to_file 'config/environments/test.md', 'config.gem "rspec"'
  #
  #   prepend_to_file 'config/environments/test.md' do
  #     'config.gem "rspec"'
  #   end
  #
